...
import nitrr.meghal.helper.utils.Device;
import nitrr.meghal.helper.utils.File;
import nitrr.meghal.helper.utils.Filesystem;
import nitrr.meghal.helper.utils.Memory;
import nitrr.meghal.helper.utils.io.FileReader;
import nitrr.meghal.helper.utils.io.FileWriter;
...
public class RootFW {
	 ...
	 */
	public static interface OnConnectionListener extends Shell.OnShellConnectionListener {
		/**
	...
	public static Boolean connect() {
		synchronized(mLock) {
			if (mShell == null || !mShell.isConnected()) {
				...
				mShell.addShellConnectionListener(new Shell.OnShellConnectionListener(){
					@Override
	 ...
	 */
	public static Shell.Result execute(String command) {
	 ...
	 * @see Shell#execute(String[])
	 */
	public static Shell.Result execute(String[] commands) {
		return mShell.execute(commands);
	}
	
	/**
	 * @see Shell#execute(String[], Integer[], Shell.OnShellValidateListener)
	 */
	public static Shell.Result execute(String[] commands, Integer[] resultCodes, Shell.OnShellValidateListener validater) {
		return mShell.execute(commands, resultCodes, validater);
	}
	
	/**
	 * @see Shell#executeAsync(String, Shell.OnShellResultListener)
	 */
	public static void executeAsync(String command, Shell.OnShellResultListener listener) {
	 ...
	 * @see Shell#executeAsync(String[], Shell.OnShellResultListener)
	 */
	public static void executeAsync(String[] commands, Shell.OnShellResultListener listener) {
		mShell.executeAsync(commands, listener);
	}
	
	/**
	 * @see Shell#executeAsync(String[], Integer[], Shell.OnShellValidateListener, Shell.OnShellResultListener)
	 */
	public static void executeAsync(String[] commands, Integer[] resultCodes, Shell.OnShellValidateListener validater, Shell.OnShellResultListener listener) {
	 ...
	 */
	public static Shell.Attempts createAttempts(String command) {
	 ...
	 */
	public static Filesystem.Disk getDisk(String disk) {
	 ...
	 */
	public static Memory.Swap getSwap(String device) {
