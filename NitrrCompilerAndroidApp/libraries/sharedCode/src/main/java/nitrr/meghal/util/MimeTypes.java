...
package nitrr.meghal.util;

public class MimeTypes {
    public static final String[] MIME_TEXT = {
            "ajx", "am", "asa", "asc", "asp", "aspx", "awk", "bat", "Constants", "cdf", "cf", "cfg", "cfm", "cgi", "cnf", "conf",
    ...
    public static final String[] MIME_CODE = {
    	    "cs", "php", "js", "java", "py", "rb", "aspx", "cshtml", "vbhtml", "go", "Constants", "h", "cc", "cpp", "hh", "hpp", "pl", "pm", "t", "pod",
