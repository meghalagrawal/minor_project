...
import nitrr.meghal.helper.Constants;
import nitrr.meghal.helper.RootFW;
...
import nitrr.meghal.adapter.AdapterDrawer;
import nitrr.meghal.compiler.model.RetrofitCompilerHelper;
import nitrr.meghal.compiler.presenter.CompilerPresenter;
import nitrr.meghal.compiler.presenter.CompilerPresenterImpl;
import nitrr.meghal.compiler.view.CompilerView;
import nitrr.meghal.dialogfragment.ChangelogDialog;
import nitrr.meghal.dialogfragment.EditTextDialog;
import nitrr.meghal.dialogfragment.FileInfoDialog;
import nitrr.meghal.dialogfragment.FindTextDialog;
...
import nitrr.meghal.task.SaveFileTask;
import nitrr.meghal.texteditor.EditTextPadding;
import nitrr.meghal.texteditor.FileUtils;
import nitrr.meghal.texteditor.LineUtils;
import nitrr.meghal.texteditor.PageSystem;
import nitrr.meghal.texteditor.PageSystemButtons;
import nitrr.meghal.texteditor.Patterns;
import nitrr.meghal.texteditor.SearchResult;
import nitrr.meghal.util.AccessStorageApi;
import nitrr.meghal.util.AccessoryView;
import nitrr.meghal.util.AnimationUtils;
import nitrr.meghal.util.AppInfoHelper;
import nitrr.meghal.util.Device;
import nitrr.meghal.util.GreatUri;
import nitrr.meghal.util.IHomeActivity;
import nitrr.meghal.util.MimeTypes;
import nitrr.meghal.util.ProCheckUtils;
import nitrr.meghal.util.ThemeUtils;
import nitrr.meghal.util.ViewUtils;
import nitrr.meghal.views.CustomDrawerLayout;
...
//        stdin = (EditText)findViewById(R.id.stdin_input);
        ...
        progressDialog.setTitle("Compiling in NITRR Compilers . .");
...
//                    Toast.makeText(MainActivity.this, "Spinner Item clicked. "+selectedItem, Toast.LENGTH_SHORT).show();
    ...
    private ArrayList<String > getLanguageList(){
        ...
        list.add(Constants.C_PLUS_PLUA);
        list.add(Constants.JAVA);
        list.add(Constants.PYTHON);
        list.add(Constants.PHP);
        list.add(Constants.JAVASCRIPT);
        list.add(Constants.MYSQL);
        list.add(Constants.BASH);
        list.add(Constants.C_HASH);
        list.add(Constants.CLOJURE);
        list.add(Constants.VB_NET);
        list.add(Constants.SCALA);
        list.add(Constants.RUBY);
        list.add(Constants.PERL);
        list.add(Constants.OBJECTIVE_C);
        list.add(Constants.RUST);
        list.add(Constants.GO);
